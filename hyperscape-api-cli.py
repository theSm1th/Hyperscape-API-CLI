...
uidURL = "https://hypers.apitab.com/player/{}?x={}"
request = urllib.request.Request(uidURL.format(uid, 1597420964), data=None, headers={"User-Agent" : "Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:81.0) Gecko/20100101 Firefox/81.0"})
with urllib.request.urlopen(request) as openURL:
